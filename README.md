...
**▶ [바로 플레이](https://gemini9764.github.io/company-tycoon/)** — `src/` 를 그대로 서빙한다. 배포용 단일 파일이 필요하면 `배포본-만들기` 를 실행한다.

<img src="shots/city.png" width="420" alt="M&A 모드 — 도시 맵"> <img src="shots/store.png" width="420" alt="경영 모드 — 매장 내부">
