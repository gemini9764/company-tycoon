...
const BAL = {
  ...
  /* 도시 블록 격자. 타일 수 = cityBlocks × 3.
     8×8 로 키워 봤더니 월드 높이가 432가 되어 PX=2 를 유지하는 데 캔버스 높이가
     864px 필요했다 (기존 808px). 북마크 바 하나로 배율이 절반이 되는 실패 모드라
     7×7 로 되돌리고, 대신 회사 밀도를 올렸다. 자세한 계산은 GRAPHICS.md. */
  cityBlocks: 7,             // 7×7 = 49칸
  npcCount: 38,              // 회사 38 + 자사 1 = 39칸. 남는 10칸은 렌더가 지형으로 채운다
